/* ===================================================
   フランス語学習アプリ  script.js
   =================================================== */

// ===== Default Words =====
const DEFAULT_WORDS = [
  { word: 'bonjour', japanese: 'こんにちは', example: 'Bonjour! Comment allez-vous?', notes: '挨拶', mastered: false },
  { word: 'merci', japanese: 'ありがとう', example: 'Merci beaucoup pour votre aide.', notes: '挨拶', mastered: false },
  { word: 'au revoir', japanese: 'さようなら', example: 'Au revoir! À bientôt!', notes: '挨拶', mastered: false },
  { word: "s'il vous plaît", japanese: 'お願いします', example: "De l'eau, s'il vous plaît.", notes: '礼儀', mastered: false },
  { word: 'être', japanese: '〜である', example: 'Je suis étudiant.', notes: '基本動詞', mastered: false },
  { word: 'avoir', japanese: '持っている', example: "J'ai un chat.", notes: '基本動詞', mastered: false },
  { word: 'aller', japanese: '行く', example: "Je vais à l'école.", notes: '動詞', mastered: false },
  { word: 'manger', japanese: '食べる', example: 'Je mange une pomme.', notes: '動詞', mastered: false },
  { word: 'maison', japanese: '家', example: 'Je rentre à la maison.', notes: '名詞', mastered: false },
  { word: 'ami', japanese: '友達', example: 'Il est mon meilleur ami.', notes: '名詞', mastered: false },
];

// ===== Storage =====
const STORAGE_KEYS = {
  WORDS: 'french_words',
  QUIZ_HISTORY: 'french_quiz_history',
};
  ...
  card.addEventListener('click', () => {
    ...
    importPreviewList.innerHTML = set.words.slice(0, 10).map(w =>
      `<div class="preview-word-row">
        <span class="preview-en">${escHtml(w.word)}</span>
