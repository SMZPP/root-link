...
// ===== Default Words =====
const DEFAULT_WORDS = [
  { word: 'Hallo', japanese: 'こんにちは', example: 'Hallo! Wie geht es Ihnen?', notes: '挨拶', mastered: false },
  { word: 'Danke', japanese: 'ありがとう', example: 'Danke schön für Ihre Hilfe!', notes: '挨拶', mastered: false },
  { word: 'Auf Wiedersehen', japanese: 'さようなら', example: 'Auf Wiedersehen! Bis bald!', notes: '挨拶', mastered: false },
  { word: 'Bitte', japanese: 'お願いします・どういたしまして', example: 'Ein Kaffee, bitte.', notes: '礼儀', mastered: false },
  { word: 'sein', japanese: '〜である', example: 'Ich bin Student.', notes: '基本動詞', mastered: false },
  { word: 'haben', japanese: '持っている', example: 'Ich habe eine Katze.', notes: '基本動詞', mastered: false },
  { word: 'gehen', japanese: '行く', example: 'Ich gehe zur Schule.', notes: '動詞', mastered: false },
  { word: 'essen', japanese: '食べる', example: 'Ich esse einen Apfel.', notes: '動詞', mastered: false },
  { word: 'Haus', japanese: '家', example: 'Ich gehe nach Hause.', notes: '名詞(中性)', mastered: false },
  { word: 'Freund', japanese: '友達（男性）', example: 'Er ist mein bester Freund.', notes: '名詞(男性)', mastered: false },
];

// ===== Storage =====
const STORAGE_KEYS = {
  WORDS: 'german_words',
  QUIZ_HISTORY: 'german_quiz_history',
};
